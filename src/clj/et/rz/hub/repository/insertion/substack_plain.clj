(ns et.rz.hub.repository.insertion.substack-plain
...
(defn match? [title] (re-matches #"https://substack.com\/home\/post\/p-.*" title))
...
(defn save-article
  ...
  (let [url (url/url-without-query-params url)
        ...
        {:keys [title content date year image type]} (substack/get-post url
