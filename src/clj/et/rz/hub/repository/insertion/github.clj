(ns et.rz.hub.repository.insertion.github
...
(defn- get-github-user-id
  [db user github-platform-id github-orgs-id]
...
(defn- create-or-take-github-user-id
  [db user github-platform-id github-users-id]
  (let [github-user-id (:id (datastore/get-item-by-path db
                                                        "data->'resource-links'->>'github-user'"
                                                        (str "https://github.com/" user)))
        github-user-id (or github-user-id
                           (get-github-user-id db user github-platform-id github-users-id))]
    github-user-id))
...
(defn save-article
  ...
  (let [url (url/url-without-query-params url)
        ...
        github-user-id (create-or-take-github-user-id db
    ...
    (if (:id existing-item)
      ...
      (let [item (common/insert-item db title short-title context-ids-set {:github-repo url})]
