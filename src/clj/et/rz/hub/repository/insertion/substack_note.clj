(ns et.rz.hub.repository.insertion.substack-note
  (:require [clojure.string :as str]
            [cambium.core :as log]
            [et.rz.hub.ds :as datastore]
            [et.rz.hub.repository.insertion.common :as common]
            et.rz.hub.scrapers.substack-note
            et.rz.utils
...
(defn ingest
  ...
  (let [substack-platform-id (common/get-item-or-throw-error db "Substack")
        ...
        tree (et.rz.hub.scrapers.substack-note/get-tree note-id)
        {:keys [title date year image description]} (et.rz.hub.scrapers.substack-note/get-date tree)
